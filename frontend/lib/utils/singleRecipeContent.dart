...
//                             child: InkWell(
//                               onTap: () {
//                                 debugPrint(widget.data.user.pk);
//                                 p.likeRecipie(widget.data.pk.toString(),widget.data.user.pk.toString(),
//                                     animationController!);
//                               },
//                               child: Lottie.asset(
...
//                           InkWell(
//                             onTap: (){
//                               showReactorList(context,controller,widget.data.reaction);
//                             },
